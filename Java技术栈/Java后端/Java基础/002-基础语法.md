...
| int  Integer.intValue()    | 以int类型返回该Integer的值                                   | Double d = new Double(2.1);     **float f = d.floatValue();** |
| Integer.parseInt(String s) | 把数值型的String类型转化为int类型                            | **int a = Integer.parseInt("1234");**                        |
| Integer.valueOf(String s)  | 把数值型的String类型转化为Integer类型                        | **Integer b = Integer.valueOf("1234");**                     |
